    ...
    <>
      ...
      <div className="relative z-[100]">
        <button
          ...
          className="flex items-center gap-3 px-4 py-2.5 rounded-xl bg-white/10 hover:bg-white/20 transition-all border border-white/20 backdrop-blur-sm relative z-[100]"
        >
        ...
        {isOpen && (
          <>
            ...
            />
            <div className="absolute right-0 mt-2 w-72 bg-white rounded-xl shadow-2xl border border-gray-200 overflow-hidden z-[100]">
